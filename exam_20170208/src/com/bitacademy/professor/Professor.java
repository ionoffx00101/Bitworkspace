...
public class Professor {
	...
	public Long sal;//월급
	public Date hiredate;//입사일 데이터 베이스에서 date를 가져올때는 java.sql.date를 import해새ㅓ 써야한다
	...
	// @JoinColumn(name="tb_professor.deptno", referencedColumnName="tb_department.deptno")
	...
	public String toString() {
		return "Professor [profno=" + profno + ", name=" + name + ", userid=" + userid + ", position=" + position + ", sal=" + sal + ", hiredate="
				+ hiredate + ", comm=" + comm + ", dept=" + dept + "]";
	}
