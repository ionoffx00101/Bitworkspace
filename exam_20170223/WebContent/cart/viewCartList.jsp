...
<body>
	...
	<c:forEach items="${CART_LIST}" var="cart">
		<tr>
			<td>
				<a href="/exam_20170223/viewGood.do?gnum=${cart.gnum}">${cart.gnum}</a>
			</td>
			<td>
				<img src="/exam_20170223/photo/${cart.img}"/>
			</td>
			<td>
				${cart.name}
			</td>
			<td>
				${cart.qty}
				<form action="/exam_20170223/removeCart.do" method="post">
	...
	<p align="center"><a href="/exam_20170223/viewGoodList.do">쇼핑하기</a></p>
